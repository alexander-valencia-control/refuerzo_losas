...
if st.button("Procesar"):
    Datos           = pd.read_csv(st.session_state['uploaded_file'], sep="\\t", engine='python', encoding='UTF-16')
    ...
    Datos2          = pd.read_csv(st.session_state['uploaded_file2'], sep="\\t", engine='python', encoding='UTF-16')
